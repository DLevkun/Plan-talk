...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div style="margin-left:auto;margin-right:50px;" class="hidden top-0 right-0 py-3 sm:block">
                    @auth
    ...
    <div class="container">
        <h1 class="header">Plan Talk</h1>
        <p class="app-descr">The first social net for planning and setting goals. For REALLY successful people</p>
        <ol class="add-properties">
            <div class="list-col">
                <li>Communicate with people</li>
                <li>Exchange experience</li>
                <li>Tell about your life</li>
                <li>Develop your knowledge</li>
            </div>
            <div class="list-col">
                <li>Set goals and watch the progress</li>
                <li>Follow different communities</li>
                <li>Make friends</li>
                <li>Reach success</li>
            </div>
        </ol>
        ...
        <div class="impulse mt-5 mb-5">
            <h1>If you are not registered yet, go and nail it!</h1>
